...
class Pdf extends FPDF{
	...
	function Header()
	{
		//Logo
		global $title;
		$this->Image(APPPATH .'/libraries/mediatama.jpg',75,5,'R');
	...
	function Content(){
        ...
        $this->Ln();
        //baris 5
		$this->Cell(40,6,'Rabat','',0,'L',false);
        $this->Cell(35,6,': '.$title['head']['rabat'].' %','',0,'L',false);
        $this->Cell(25,6,'','',0,'L',false);
        ...
        $this->Ln();
        //baris 7
		$this->Cell(40,6,'Nama Penerima','',0,'L',false);
        ...
        $this->Ln();
        //baris 8
		$this->Cell(40,6,'No Telp Penerima','',0,'L',false);
        ...
        $this->Cell(65,6,'Judul','TB',0,'C',false);
		$this->Cell(22,6,'Jumlah DO','TB',0,'C',false);
        $this->Cell(25,6,'Penerbit','TB',0,'C',false);
		...
		foreach ($title['tabel'] as $tabel ) {
	        ...
	        $this->Cell(65,6,$tabel['judul'],'B',0,'L',false);//judul
			$this->Cell(22,6,$tabel['jumlah_beli'],'B',0,'C',false);//jumlah beli
	        $this->Cell(25,6,$tabel['nama_penerbit'],'B',0,'C',false);//penerbit
	        $this->Cell(18,6,$tabel['jenjang'],'B',0,'L',false);//jenjang
	        $this->Cell(11,6,$tabel['edisi'],'B',0,'C',false);//edisi
	        $this->Cell(20,6,$tabel['stok_pesan'],'B',0,'L',false);//stok pesan
	        $no++;
		}
		//footer
			$this->Ln();
			...
			$this->Cell(22,6,$title['head']['jumlah'],'T',0,'C',false);
