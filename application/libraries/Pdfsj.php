...
class Pdfsj extends FPDF{
	...
	function Header()
	{
		...
		$this->Cell(0,0,'SURAT JALAN',0,0,'C');
		$this->Ln(5);
		// header
        ...
        $this->Cell($w[2],5,'','',0,'L',false);
		$this->Cell($w[3],5,'Driver/Hp','',0,'L',false);
        ...
        $this->Ln();
        //baris 6
		$this->Cell($w[0],5,'Nama Plgn','',0,'L',false);
        $this->Cell($w[1],5,': '.$title['head']['nama_penerima'],'',0,'L',false);
        $this->Cell($w[2],5,'','',0,'L',false);
		$this->Cell($w[3],5,'Jumlah Koli/Karung','',0,'L',false);
        $this->Cell($w[4],5,': '.$title['head']['koli'].'/'.$title['head']['karung'],'',0,'L',false);
        $this->Ln();
        //baris 7
		$this->Cell($w[0],5,'Telp Plgn','',0,'L',false);
        $this->Cell($w[1],5,': '.$title['head']['no_telp_penerima'],'',0,'L',false);
        $this->Cell($w[2],5,'','',0,'L',false);
		$this->Cell($w[3],5,'Sales','',0,'L',false);
        $this->Cell($w[4],5,': '.$title['head']['nama_sales'],'',0,'L',false);
        $this->Ln();
        //baris 8
		$this->Cell($w[0],5,'Dana','',0,'L',false);
        $this->Cell($w[1],5,': '.$title['head']['sumber_dana'],'',0,'L',false);
        $this->Cell($w[2],5,'','',0,'L',false);
		$this->Cell($w[3],5,'Koordinator','',0,'L',false);
        $this->Cell($w[4],5,': '.$title['head']['nama_kaper'],'',0,'L',false);
        $this->Ln();
        //baris 9
		$this->Cell($w[0],5,'Alamat Kirim','',0,'L',false);
        $this->Cell($w[1],5,': '.$title['head']['alamat_penerima'],'',0,'L',false);
        $this->Cell($w[2],5,'','',0,'L',false);
