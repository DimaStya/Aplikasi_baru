...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Pemasaran/Ambil_requpdate"); ?>",
    ...
    $('#klik<? echo $no;?>').click(function(){ 
      $('#loadingklik').show();
      $.ajax({
        type: 'POST',
        url: "<?php echo base_url("Pemasaran/Data_requpdate"); ?>",
        data: {data : $("#klik<? echo $no;?>").val()}, 
        dataType: 'json',
        beforeSend: function(e) {
          if(e && e.overrideMimeType) {
            e.overrideMimeType('application/json;charset=UTF-8');
        ...
        success: function(response){
          ...
          document.getElementById('no_suratretur').innerHTML = $("#klik<? echo $no;?>").val();
        },
      });
    });
    <?php $no++; }?>
