                ...
                <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;">
                  ...
                  <?php $no=1; foreach ($pesanan as $pesanan) {?>
                    <tr class="GridViewScrollItem">
                      ...
                      <td scope="col"><?php echo $pesanan['no_sj_stkmini']; ?></td>
                      <td scope="col">
                         <form method='POST' action="<?php echo base_url().'Gudang/Cetakpdf_stokmini/'; ?>">
                          <button name='no_sj_stkmini' value='<?php echo $pesanan['no_sj_stkmini']; ?>' type='submit' class='btn btn-info'>Cetak Ulang SJ</button>
                        </form>
                      </td>
                      <td scope="col"><a href="<?php echo base_url().'Gudang/Hapus_sjstokmini/?no_sj_stkmini='.$pesanan['no_sj_stkmini']; ?>" onclick="return(confirm('Yakin data akan dihapus?'));"><button type='button' class='btn btn-danger'>Hapus</button></a></td>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Gudang/Ambil_dataselesai_stokmini"); ?>",
