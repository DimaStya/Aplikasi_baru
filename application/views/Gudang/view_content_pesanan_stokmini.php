                ...
                <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;">
                  ...
                  <?php $no=1; foreach ($pesanan as $pesanan) {?>
                    <tr class="GridViewScrollItem">
                      ...
                      <td scope="col">
                        <button name="approve" value="<?php echo $pesanan['no_do_stokmini']; ?>" type="submit" class="btn btn-info">Detail</button></td>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Gudang/Ambil_data_stokmini"); ?>",
