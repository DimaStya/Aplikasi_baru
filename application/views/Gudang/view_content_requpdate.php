            ...
            <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;">
                  ...
                  <?php $no=1; foreach ($requpdate as $requpdate) {?>
                    ...
                    <tr class="GridViewScrollItem">
                      ...
                      <td scope="col"><?php echo $requpdate['no_suratretur']; ?></td>
                      <td scope="col">
                      <form action='<?php echo base_url()."Gudang/Hapus_nota/update/";?>' method='GET'>
                        <button name='kode_retur' id='kode_retur' value='<?php echo $requpdate['kode_retur'];?>' type='submit' class='btn btn-warning'>Update</button>
                      </form></td>
                  </tr>
                  <?php $no++; }?>
                  </tbody>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Gudang/Ambil_requpdate"); ?>",
