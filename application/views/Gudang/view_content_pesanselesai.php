                ...
                <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;">
                  ...
                  <?php $no=1; foreach ($pesanan as $pesanan) {?>
                    <tr class="GridViewScrollItem">
                      ...
                      <td scope="col">
                        <button type="button" name="klik<?php echo $no;?>" id="klik<?php echo $no;?>" value="<?php echo $pesanan['no_do']; ?>" class="btn btn-info" data-toggle="modal" data-target="#myModal">Detail</button></td>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Gudang/Ambil_pesanselesai"); ?>",
