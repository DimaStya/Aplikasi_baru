                ...
                <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;">
                  ...
                  <?php $no=1; foreach ($pesanan as $pesanan) {?>
                    <tr class="GridViewScrollItem">
                      ...
                      <td scope="col"><?php echo $pesanan['tgl_sj']; ?></td>
                      <td scope="col"><?php echo $pesanan['no_suratjalan']; ?></td>
                      <td scope="col"><?php echo $pesanan['no_pesanan']; ?></td>
                      <td scope="col">
                        <form method='POST' action="<?php echo base_url().'Gudang/Cetakpdf/'; ?>">
                      <button name='no_suratjalan' value='<?php echo $pesanan['no_suratjalan']; ?>' type='submit' class='btn btn-info'>Cetak Ulang SJ</button>
                    </form></td>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Gudang/Ambil_dataselesai"); ?>",
