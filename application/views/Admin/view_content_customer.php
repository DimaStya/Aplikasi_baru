    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Kelola Data customer</h4>
        </div>
        <!-- body modal -->
        <div class="modal-body">
          <div class="box box-primary">
            
              <form role="form" action="<?php echo base_url().'Proses/Add_customer'; ?>" autocomplete="off" method="POST">
                ...
                <div class="form-group"> 
                  <div class="col-xs-6">
                      ...
                      <input type="text" class="form-control col-xs-6" name="nama_customer" id="nama_customer"  placeholder="Nama Customer" required="">
                  </div>
                </div>
              </div>
                <div class="box-body">
    ...
    <section class="content">
      <div class="box box-success">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php $no=1; foreach ($data1 as $customer) { ?>
                  <tr>
                    <td><?php echo $no;?></td>
  ...
  <?php $no=1; foreach ($data1 as $customer) { 
    echo "
      function Klik".$no."(){
        ...
        if(r == true){
          window.location = '".base_url()."Proses/Hapus_customer/".$customer['kode_customer']."';
        }
