<script src = "<?php echo base_url('js/sales.js'); ?>"></script>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="box box-primary">
              ...
              <form role="form" action="<?php echo base_url().'Proses/Add_sales'; ?>" autocomplete="off" method="POST">
                ...
                <div class="form-group"> 
                  <div class="col-xs-6">
                      ...
                      <input type="text" class="form-control col-xs-6" name="nama_sales" id="nama_sales"  placeholder="Nama Lengkap" required="">
                  </div>
                </div>
              </div>
              <div class="box-body">
  ...
  <?php $no=1; foreach ($data1 as $sales) { 
    echo "
      function Klik".$no."(){
        ...
        if(r == true){
          window.location = '".base_url()."Proses/Hapus_sales/".$sales['kode_sales']."';
        }
