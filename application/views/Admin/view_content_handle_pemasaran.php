<script src = "<?php echo base_url('js/handle_pemasaran.js'); ?>"></script>
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Wilayah Pemasaran</li>
    </ol>
  </section>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Kelola Data Handle Pemasaran</h4>
        </div>
        <!-- body modal -->
        <div class="modal-body">
          <div class="box box-primary">
              <form role="form" action="<?php echo base_url().'Handle/Pemasaran'; ?>" method="POST">
                <div class="box-body">
                  <div class="col-lg-6">                   
                    <label>Pilih Nama Admin Pusat</label>
                      <select class="form-control" id ='kode_admpusat' name='kode_admpusat' required="">
                      <option value= "">--Pilih Nama Admin Pusat--</option>
                      <?php foreach ($data2 as $admpusat) { 
                        echo '<option value= "'.$admpusat['kode_admpusat'].'">'.$admpusat['nama_admpusat'].'</option>';
                      }?>
                      </select>
                  </div>
                  </div>
          ...
          <div class="box box-primary">
              <form role="form" action="<?php echo base_url().'Handle/Pemasaran'; ?>" method="POST">
                ...
                <div class="box-body">
                  <div class="col-lg-6">                   
                    <label>Pilih Nama Admin Pusat</label>
                      <select class="form-control" id ='kode_admpusat1' name='kode_admpusat1' required="">
    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Data Wilayah Pemasaran</h3>&nbsp;<button type="button" class="btn-info" data-toggle="modal" data-target="#myModal" onclick= "SetInput('','','','','','')">+</button>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo $no;?></td>
                     <td><?php echo $handle['nama_admpusat'];?></td>
  ...
  <?php $no=1; foreach ($data1 as $handle) { 
    echo "
      function Klik".$no."(){
        ...
        if(r == true){
          window.location = '".base_url()."Handle/Hapus_Pemasaran/".$handle['kode_handle']."';
        }
...
<script type="text/javascript">
  <?php $no=1; foreach ($data1 as $handle) { ?>
    function ubah<?php echo $no;?>(){
      ...
      document.getElementById('kode_admpusat1').innerHTML='<option value= "">--Pilih Admin Pusat Pengganti--</option>  <?php foreach ($data2 as $admpusat) {if ($admpusat['kode_admpusat'] != $handle['kode_admpusat']){echo '<option value="'.$admpusat['kode_admpusat'].'">'.$admpusat['nama_admpusat'].'</option>';}}?>';
    }
  <?php $no++;} ?>
