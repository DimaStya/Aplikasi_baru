<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Report Rekanan</li>
    </ol>
  </section>
    <section class="content">
      <div class="box box-success">
        <form action="<?php echo base_url().'Report/Excel_rekanan';?>" method="POST">
            <div class="box-header with-border">
              <h3 class="box-title">Report Rekanan</h3> &nbsp;
...
<script>
  ...
  $("#loadingt").hide();
    $("#cari").click(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Report/Cari_rekanan"); ?>",
