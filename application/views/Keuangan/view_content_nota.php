    ...
    <section class="content">
      <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Daftar TTR</h3>
            ...
            <div class="box-body">
                <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;">
                  ...
                  <?php $no=1; foreach ($nota as $nota) {?>
                    <tr class="GridViewScrollItem">
                      <td scope="col"><?php echo $no; ?></td>
                      <td scope="col"><?php echo $nota['tanggal']; ?></td>
                      <td scope="col"><?php echo $nota['no_notaretur']; ?></td>
                      <td scope="col"><?php echo $nota['kode_retur']; ?></td>
                      <td scope="col"><?php echo $nota['no_faktur']; ?></td>
                      <td scope="col"><?php echo $nota['alasan']; ?></td>
                      <td scope="col">
                        <form action="<?php echo base_url().'Keuangan/Cetakpdf_notaretur/';?>" method="POST">
                        <button name="no_notaretur" id="no_notaretur" value="<?php echo $nota['no_notaretur']; ?>" type="submit" class="btn btn-info">Download</button></form></td>
                        <td scope="col">
                          <?php if($nota['keterangan'] == 'Admin Telah Menerima'){?>
                            <button type="button" class="btn btn-danger" onclick='Klik<?php echo $no;?>()'>Hapus</button>
                          <script type="text/javascript">
                              function Klik<?php echo $no;?>(){
                                var r = confirm('Yakin Nota Dihapus?');
                                if(r == true){
                                  window.location = '<?php echo base_url()."Keuangan/Hapus_nota/?dari=hapus&&no_notaretur=".$nota['no_notaretur'];?>';
                                }
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Keuangan/Ambil_nota"); ?>",
