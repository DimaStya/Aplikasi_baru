    ...
    <div class="modal-dialog" style="width: 75%;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Detail TTR</h4>
          <div class="col-lg-3">
      ...
      <div class="box box-success">
            ...
            <div class="box-body">
                <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;">
                  ...
                  <?php $no=1; foreach ($ttr as $ttr) {?>
                    <tr class="GridViewScrollItem">
                      <td scope="col"><?php echo $no; ?></td>
                      <td scope="col"><?php echo $ttr['tanggal']; ?></td>
                      <td scope="col"><?php echo $ttr['no_faktur']; ?></td>
                      <td scope="col"><?php echo $ttr['kode_retur']; ?></td>
                      <td scope="col"><?php echo $ttr['alasan']; ?></td>
                      <td scope="col">
                        <button name="klik<?php echo $no;?>" id="klik<?php echo $no;?>" value="<?php echo $ttr['kode_retur']; ?>" type="button" class="btn btn-info"  data-toggle="modal" data-target="#myModal">Detail</button></td>
                  </tr>
                  <?php $no++; }?>
                  </tbody>
              </table>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Keuangan/Ambil_ttr"); ?>",
    ...
    $('#klik<?php echo $no;?>').click(function(){ 
      ...
      $.ajax({
        type: 'POST',
        url: "<?php echo base_url("Keuangan/Data_ttr"); ?>",
