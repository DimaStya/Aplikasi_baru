  ...
  <section class="content-header">
    ...
    <section class="content">
      <div class="box box-success">
            ...
            <hr>
            <div class="box-body">
            <form method="POST" action="<?php echo base_url().'Keuangan/DetailFaktur/';?>">
                <table cellspacing="0" id="gvMain" style="width: 100%; border-collapse: collapse;">
                  ...
                  <?php $no=1; foreach ($pesanan as $pesanan) {?>
                    <tr class="GridViewScrollItem">
                      ...
                      <td scope="col">
                        <button name="SJ" value="<?php echo $pesanan['no_suratjalan']; ?>" type="submit" class="btn btn-info">Detail</button></td>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#kode_wilayah").change(function(){ 
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("Keuangan/Ambil_data"); ?>",
