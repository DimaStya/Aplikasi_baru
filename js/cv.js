function SetInput(kode_area, kode_perwakilan,kode_cv,kode_nasional,nama_area,alamat_perwakilan,
	nama_cv,no_telp, alamat_cv){
	...
	document.getElementById("alamat_cv").value = alamat_cv;
