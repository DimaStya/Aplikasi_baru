function SetInput(kode_area, kode_perwakilan,kode_customer,kode_nasional,
	nama_area,alamat_perwakilan,nama_customer,alamat_customer){
	...
	document.getElementById("alamat_customer").value = alamat_customer;
